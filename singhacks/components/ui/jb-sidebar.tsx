        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-700 transition hover:bg-white/80 hover:text-slate-900 dark:text-slate-100 dark:hover:bg-slate-800",
                item.active &&
